...
if __name__ == '__main__':
    ...
    while total_runs < NUM_TRAINING_ITERATIONS:        
        ...
        #output of 1st layer becomes input of 2nd layer
        #edit
        ...
        #edit
        z = err(y.layer_out[0],target[curr_point])
    ...
    while total_runs < len(f):        
        ...
        # set up the second layer and evaluate it
        #output of layer 1 becomes input of 2nd layer
        #edit
        y.input_vals = x.layer_out
        y.eval()
    ...
    while curr_point < len(f):
        ...
        # set up the second layer and evaluate it
        #output of 1st layer becomes input of layer 2
        #edit
        y.input_vals = x.layer_out
        y.eval()
